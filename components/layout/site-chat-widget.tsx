  ...
  return (
    <div className={`site-chat-widget${isOpen ? " is-open" : ""}`}>
        ...
        <div className="site-chat-panel-shell">
            ...
            {isSubmitting ? (
              <div className="site-chat-row site-chat-row-assistant">
                ...
                <div className="site-chat-message site-chat-message-assistant site-chat-message-loading">
                  <div className="site-chat-typing" aria-label="Lena is typing">
                    <span />
                    <span />
                    <span />
                  </div>
          ...
          {error ? (
            <div className="site-chat-error">
              ...
              <p>I couldn&apos;t reply just now. Please try again in a moment.</p>
            </div>
          ) : null}
      ...
      <button
        ...
        aria-label={isOpen ? "Close chat" : "Open chat with Lena"}
      ...
      >
        ...
        <span className="sr-only">Chat with Lena</span>
      </button>
    </div>
  );
}
